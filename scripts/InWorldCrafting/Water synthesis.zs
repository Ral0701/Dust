...
//灰尘-灰沙
FluidToItem.transform(<contenttweaker:grey_sand>,
<liquid:water>,
[<contenttweaker:dust>],false);
//小搓沙
FluidToItem.transform(<contenttweaker:small_rubbing_sand>,
<liquid:water>,
[<contenttweaker:grey_sand>],false);
//沙砾
FluidToItem.transform(<minecraft:gravel>,
<liquid:water>,
[<minecraft:sand>,<contenttweaker:ash_mixture>,<contenttweaker:small_rubbing_charcoal>],false);
//水瓶
...
<liquid:water>,
[<contenttweaker:turbid_glass>],false);
//树苗转换
...
//黑铁锭
FluidToItem.transform(<extendedcrafting:material:1>,<liquid:water>,[<minecraft:iron_ingot>,<minecraft:obsidian>,<ore:dyeBlack>],true);